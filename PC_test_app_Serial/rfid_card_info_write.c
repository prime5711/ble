...
int main(int argc, char *argv[])
{
	...
	printf("NUGA_ID=0x%02x%02x%02x%02x\n",  NUGA_ID[3],NUGA_ID[2], NUGA_ID[1],NUGA_ID[0]);
	...
	switch(argc)
	{
		...
		case 3:
			...
			break;
		case 1:
			printf("Usage : ./a.exe /dev/com15 [r|w] : 실행한 후에 Card를 접촉하면\n");
			printf("\n");
			printf("                - defauklt filename is userinfo.txt( UTF-8 형식).\n");
			printf("\n");
			printf("                - Uart번호는 장치관리자를 보면  알수 있습니다.\n");
			return -1;
	}
	///////////////////////////////////////////////////////////////////////////////
